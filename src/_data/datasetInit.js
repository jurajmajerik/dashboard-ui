export const datasetInit = {
  ...
  'United Kingdom': [
    { title: 'Article 6', topics: [2] },
    { title: 'Article 7', topics: [1, 3] },
    { title: 'Article 8', topics: [1, 2, 4] },
    { title: 'Article 9', topics: [1] },
    { title: 'Article 10', topics: [4] },
    { title: 'Article 11', topics: [1] },
  ],
  Netherlands: [
