...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "36b1adb64be7ca1a8a78";
...
app.use(express__WEBPACK_IMPORTED_MODULE_2___default.a.static(path__WEBPACK_IMPORTED_MODULE_1___default.a.join(process.env.PWD, 'static'))); // Fallback route
...
var port = process.env.PORT || 4000; // app.listen(port, () => console.log(`Server listening on port ${port}`));

var io = socket_io__WEBPACK_IMPORTED_MODULE_5___default.a.listen(app.listen(4000));
...
rethinkdb__WEBPACK_IMPORTED_MODULE_6___default.a.connect({
  ...
  rethinkdb__WEBPACK_IMPORTED_MODULE_6___default.a.table('orders').changes().run(conn, function (err, cursor) {
