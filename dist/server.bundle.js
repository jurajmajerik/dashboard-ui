...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "8e4202ca8bebf2a8f53f";
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return resetDB; });
/* harmony import */ var _subscribeClient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./subscribeClient */ "./server/subscribeClient.js");

function resetDB(r, connection, io) {
  io.sockets.on('connection', function (socket) {
    r.table('articles_new') // 1. Delete existing articles
    ["delete"]().run(connection, function (err, result) {
      if (err) throw err;
      console.log(JSON.stringify(result, null, 2)); // 2. Insert new article

      setTimeout(function () {
        r.table('articles_new').insert([{
          title: 'New article 1',
          topics: [],
          date: new Date(),
...
/* harmony import */ var rethinkdb__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rethinkdb */ "rethinkdb");
/* harmony import */ var rethinkdb__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(rethinkdb__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _subscribeClient__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./subscribeClient */ "./server/subscribeClient.js");
/* harmony import */ var _resetDB__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./resetDB */ "./server/resetDB.js");
/* eslint-disabl */
...
rethinkdb__WEBPACK_IMPORTED_MODULE_6___default.a.connect({
  ...
  app.use(express__WEBPACK_IMPORTED_MODULE_2___default.a["static"](path__WEBPACK_IMPORTED_MODULE_1___default.a.join(process.env.PWD, 'static')));
  app.get('/api/articles', function (req, res) {
    rethinkdb__WEBPACK_IMPORTED_MODULE_6___default.a.table('articles').run(connection, function (err, cursor) {
      if (err) throw err;
  ...
  app.get('/*', function (req, res) {
    res.sendFile(path__WEBPACK_IMPORTED_MODULE_1___default.a.resolve('./static/index.html'), function (err) {
      if (err) res.status(500).send(err);
    });
  });
  var port = process.env.PORT || 4000;
  var io = socket_io__WEBPACK_IMPORTED_MODULE_5___default.a.listen(app.listen(port));
  console.log('App listening on 4000');
  Object(_resetDB__WEBPACK_IMPORTED_MODULE_8__["default"])(rethinkdb__WEBPACK_IMPORTED_MODULE_6___default.a, connection, io);
  Object(_subscribeClient__WEBPACK_IMPORTED_MODULE_7__["default"])(rethinkdb__WEBPACK_IMPORTED_MODULE_6___default.a, connection, io);
});

/***/ }),

/***/ "./server/subscribeClient.js":
/*!***********************************!*\
  !*** ./server/subscribeClient.js ***!
  \***********************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return subscribeClient; });
function subscribeClient(r, connection, io) {
  r.table('articles_new').changes({
    includeTypes: true
